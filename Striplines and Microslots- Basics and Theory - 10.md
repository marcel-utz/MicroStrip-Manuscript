...
Maxwell’s curl equations couple the magnetic field \math{\mathbf{H}} and the electric field \math{\mathbf{E}}. If we assume a harmonic time evolution of the fields with angular frequency \math{\omega}, they become
\begin{eqnarray}
